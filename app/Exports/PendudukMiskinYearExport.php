...
class PendudukMiskinYearExport implements FromQuery, WithHeadings, ShouldAutoSize, WithMapping
{
    /**
    ...
    */
    ...
    {
        return Keluarga::query()->with(['anggota_keluargas','kepala_keluarga','anggota_keluarga'])->where('is_miskin', '1')->whereYear('tanggal_miskin', $this->year);
    }
