...
class PendudukPendatangYearExport implements FromQuery, WithHeadings, ShouldAutoSize, WithMapping
{
    /**
    ...
    */
    ...
    {
        return Keluarga::query()->with(['anggota_keluargas','kepala_keluarga','anggota_keluarga'])->where('is_pendatang', '1')->whereYear('tanggal_pendatang', $this->year);
    }
