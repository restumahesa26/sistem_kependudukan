...
class PendudukPindahYearExport implements FromQuery, WithHeadings, ShouldAutoSize, WithMapping
{
    /**
    ...
    */
    ...
    {
        return Keluarga::query()->with(['anggota_keluargas','kepala_keluarga','anggota_keluarga'])->where('is_pindah', '1')->whereYear('tanggal_pindah', $this->year);
    }
