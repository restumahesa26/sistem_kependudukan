...
class PendudukPendatangExport implements FromCollection, WithHeadings, ShouldAutoSize, WithMapping
{
    /**
    ...
    */
    ...
    {
        return Keluarga::with(['anggota_keluargas','kepala_keluarga','anggota_keluarga'])->where('is_pendatang', '1')->get();
    }
