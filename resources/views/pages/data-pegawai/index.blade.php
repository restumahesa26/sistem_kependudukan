...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('data-pegawai.create') }}" class="btn btn-primary btn-sm mb-3 px-4">Tambah Data Pegawai</a>
                        ...
                        <tbody>
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->jabatan }}</td>
                                    <td>
                                        <a href="{{ route('data-pegawai.edit', $item->id) }}" class="btn btn-sm btn-primary">Ubah Data</a>
